...
public class Validate {
    ...
    public void elUsuarioIngresaALaPaginaDelPortalDeAerocivil() {
    ...
    public void elPuedeDescargarElArchivoPdf() {
        OnStage.theActorCalled("usuario").attemptsTo(Navigation.navigationpage());
    }

    @Then("^valida que si se descargo correctamente$")
    public void validaQueSiSeDescargoCorrectamente()  {
        OnStage.theActorCalled("usuario").attemptsTo(Download.DownloadPdf());
    }
}